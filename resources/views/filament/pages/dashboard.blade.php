<x-filament::page>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3 mt-4">
        <div class="bg-white dark:bg-gray-800 shadow rounded-2xl p-4">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Proyectos') }}</h2>
            <p class="text-2xl font-bold">{{ $projectsCount }}</p>
        </div>
        <div class="bg-white dark:bg-gray-800 shadow rounded-2xl p-4">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Profesores') }}</h2>
            <p class="text-2xl font-bold">{{ $teachersCount }}</p>
        </div>
        <div class="bg-white dark:bg-gray-800 shadow rounded-2xl p-4">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Consultas') }}</h2>
