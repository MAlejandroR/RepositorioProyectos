...
<template>
    ...
    <!--     bg-amber-100 rounded-2xl relative cursor-pointer">-->
    <details ref="dropDownRef" class="dropdown dropdown-end hover:bg-gray-200 rounded-xl p-2">
        ...
        <ul class="p-2 shadow right-0  menu dropdown-content z-[1]
         ...
         rounded-box w-32 absolute ">
            <li v-for="(lang, code) in list_of_lang" :key="code">
                <button class="btn-sm cursor-pointer" @click="change_lang(code)">{{ lang.lang_name }} &nbsp{{
                        lang.flag
                    }}
                </button>
            </li>
