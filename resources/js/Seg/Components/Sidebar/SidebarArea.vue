        ...
        menuItems: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {label: 'Form Layout', route: '/forms/form-layouts'}
                ]
            },
            {
                icon: `<svg
...
<template>
    <aside
        class="fixed left-0 top-0 z-9999
         flex h-screen w-72 flex-col overflow-y-auto
    ...
    >
        ...
        <div class="flex items-center
         justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <div class="no-scrollbar flex
        flex-col overflow-y-auto duration-300 ease-linear">
            <!-- Sidebar Menu -->
