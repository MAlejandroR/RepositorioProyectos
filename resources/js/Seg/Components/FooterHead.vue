...
<template>
    <div class="h-5v bg-header text-white flex flex-row
     justify-end items-center space-x-4 text-sm">
        <div class="flex flex-row space-x-2">
            ...
            <span class="text-sm hover:scale-110 hover:underline cursor-pointer transition-transform duration-200">Contacto</span>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <span class="text-sm hover:scale-110 hover:underline cursor-pointer transition-transform duration-200">Actualidad</span>

        </div>
            <svg role="img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white">
